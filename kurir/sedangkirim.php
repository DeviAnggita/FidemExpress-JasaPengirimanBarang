...
?>
    ...
    if (isset($_POST["submit"])) {
        if (selesai($_POST) > 0) {
            // header("Location: sedangkirim.php?id=$row[id]&asal_kurir=$row[asal_kurir]");
            echo "
            <script>
            alert('Barang sampai tujuan');
            window.location.replace('sedangkirim.php?id=$row[id]&asal_kurir=$row[asal_kurir]');
            </script>
            ";
        } else {
            ...
            echo "
            <script>
            alert('Barang gagal sampai tujuan');
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Dalam Pengantaran</h1>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                    $no = 1;
                                    $data = mysqli_query($conn, "SELECT * from `order` where `status` = 'Dalam Pengantaran Kurir' and asal_penerima = '$asal_kurir'");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="" method="POST">
                                                    ...
                                                    <button class="btn btn-danger" onclick="return confirm('Apakah anda yakin barang sampai tujuan?')" name="submit" type="submit">Selesai</button>
                                                </form>
                                            </td>
                                        </tr>
                            </div>
