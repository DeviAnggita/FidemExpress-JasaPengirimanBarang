                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i> Data Pengirim
                            </div>
                            <div class="card-body">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                foreach ($rows as $row) :
                                                ?>
                                            <a style="color: #FFC107;" href="editsend.php?no_resi=<?php echo $d["no_resi"];?>&id=<?php echo $row["id"];?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                            <a style="color: #E34724;" href="deleteorder.php?no_resi=<?php echo $d["no_resi"];?>&id=<?php echo $row["id"];?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </div>
