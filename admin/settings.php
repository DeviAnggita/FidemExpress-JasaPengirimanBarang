                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <div class="col-md-4">
                            <div class="card text-black" style="background-color: white;">
                                <h1 class="card-header border border-black text-center text-white" style="background-color: #20c997;">Edit Data Admin</h1>
                                <div class="card-body">
                                    <br>
                                    <div class="form-order">
                                        <form action="" method="POST" class="fw-bold">
                                            ...
                                            <a href="index.php?id=<?php echo $row['id'] ?>" role="button" class="btn btn-warning" style=" color:white" type="reset" name="cancel">Cancel</a>
                                            </div>
                                        </form>
                                    </div>
                                    <?php endforeach; ?>
