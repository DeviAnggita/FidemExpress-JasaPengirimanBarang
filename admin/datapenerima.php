        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Penerima</h1>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Data Penerima
                        </div>
                        <div class="card-body">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php
                                                ...
                                                foreach ($rows as $row) :
                                                ?>
                                            <a style="color: #FFC107;" href="editrecip.php?no.resi=<?php echo $d["no_resi"];?>&id=<?php echo $row["id"];?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
