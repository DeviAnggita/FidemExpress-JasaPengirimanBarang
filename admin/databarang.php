                            ...
                            <table id="datatablesSimple">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $d['banyak_barang']; ?></td>
                                        ...
                                        <td style="color: #a0a5b1; margin: 0 5px;">
                                            ...
                                            foreach ($rows as $row) :
                                            ?>
                                                <a style="color: #FFC107;" href="editpack.php?no.resi=<?php echo $d["no_resi"]; ?>&id=<?php echo $row["id"]; ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                                <a style="color: #E34724;" href="deleteorder.php?no.resi=<?php echo $d["no_resi"]; ?>&id=<?php echo $row["id"]; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                        </div>
