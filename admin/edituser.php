...
?>
    ...
    while ($d = mysqli_fetch_array($query_exec)) :
        if (isset($_POST["ubah"])) {
            if (ubah4($_POST) > 0) {
                // header("Location: datapengguna.php?id=$row[id]");
                echo "
            <script>
            alert('Data Berhasil Diubah');
            window.location.replace('datapengguna.php?id=$row[id]');
            </script>
            ";
        } else {
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <div class="col-md-4">
                                <div class="card text-black" style="background-color: white;">
                                    <h1 class="card-header border border-black text-center text-white" style="background-color: #20c997;">Edit Data Pengguna</h1>
                                    <div class="card-body">
                                        <br>
                                        <?php
                                        ...
                                        <div class="form-order">
                                            <form action="" method="POST" class="fw-bold">
                                                ...
                                                <div class="button mt-1" style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 20px;">
                                                    ...
                                                    <a href="datapengguna.php?id=<?php echo $row['id'] ?>" role="button" class="btn btn-warning" style=" color:white" type="reset" name="cancel">Cancel</a>
                                                </div>
                                            </form>
                                        </div>
