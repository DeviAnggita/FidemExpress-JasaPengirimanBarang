                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Laporan Pengiriman</h1>
                        <div class="print" style="text-align: right;">
                                <a style="color: black;" href="cetaklap.php" target="_BLANK" title="Print" data-toggle="tooltip"><i style="font-size: xx-large; position: relative; right:30px" class="bi bi-printer-fill"></i></a>
                                </div>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Laporan Pengiriman
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <!-- <td><a role="button" class="btn btn-success" href="detaildata.php?no_resi=<?= $d['no_resi'] ?>">Detail</a></td> -->
                                            <td style="color: #a0a5b1; margin: 0 5px; text-align: center;">
                                                <?php
                                                $id = $_GET["id"];
                                                ...
                                                foreach ($rows as $row) :
                                                ?>
                                                    <a style="color: #03A9F4; text-align: center;" href="detaildata.php?no_resi=<?= $d['no_resi'] ?>&id=<?= $row['id']?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                                    <?php endforeach; ?>
                                            </td>
                                        </tr>
                                    <?php
