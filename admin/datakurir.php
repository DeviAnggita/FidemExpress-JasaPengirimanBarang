        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Kurir</h1>
                    <a href="tambahkurir.php?id=<?php echo $row["id"]; ?>" role="button" class="btn btn-primary mb-2" style="color:white;" type="reset" name="submit">Tambah Kurir</a>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Data Kurir
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <?php
                                $no = 1;
                                $data = mysqli_query($conn, "SELECT * from `tb_kurir`");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $d['nomor_kurir']; ?></td>
                                        <td><?php echo $d['plat_kurir']; ?></td>
                                        <td><?php echo $d['asal_kurir']; ?></td>
                                        <td><?php echo $d['alamat_kurir']; ?></td>
                                        <td style="color: #a0a5b1; margin: 0 5px;">
                                                <a style="color: #FFC107;" href="editkurir.php?nama=<?php echo $d["nama_kurir"]; ?>&id=<?php echo $row["id"]; ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                                <a style="color: #E34724;" href="deletekurir.php?nama=<?php echo $d["nama_kurir"]; ?>&id=<?php echo $row["id"]; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                </div>
                                <?php
